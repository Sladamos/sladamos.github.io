...
export class ProjectService {
  ...
  readonly projects = signal<ProjectModel[]>([
    ...
    },
    {
      ...
      imgUrl: 'projects_coronaryApp.webp',
      sourceCodeUrl: 'https://github.com/Sladamos/CoronaryApp',
      teamMembers: 2,
      technologies: [
        this.technologyService.getTechnology('Python'),
        this.technologyService.getTechnology('Django'),
        this.technologyService.getTechnology('React'),
        this.technologyService.getTechnology('CSS'),
        this.technologyService.getTechnology('Three.js'),
        this.technologyService.getTechnology('Docker'),
      ],
    },
    {
      name: 'XadesEmulator',
      description:
        'XadesEmulator is an application that simulates XAdES signatures, allowing the encryption and decryption of TXT and PDF files. It uses a private key secured with a password, stored on a USB device. The application attempts to automatically detect the key but also provides the option to manually select it. The app features a styled UI and includes unit tests to ensure both security and stability.',
      imgUrl: 'projects_xadesEmulator.webp',
    ...
    },
    {
      name: 'Homepage',
      description:
        'This is a zoneless Angular 19 application designed as a personal homepage to show information about myself. It contains features such as standalone components, signal state management, using zoneless approach. The project follows a clean structure and responsive styles. It also contains different themes for seasons.',
      imgUrl: 'projects_homepage.webp',
      sourceCodeUrl: 'https://github.com/Sladamos/sladamos.github.io/tree/main/Homepage',
      teamMembers: 1,
      technologies: [
        this.technologyService.getTechnology('Angular'),
        this.technologyService.getTechnology('CSS'),
        this.technologyService.getTechnology('Figma'),
      ],
    },
    {
      name: 'Kingdom Simulation',
      description:
        'The KingdomSimulation project is an advanced simulation that manages resource production, military buildup, and combat operations within a multithreaded environment. It is a console application which uses wait(), notifyAll(), and monitor mechanisms for thread synchronization. Its functionality is verified with unit tests implemented using JUnit, Mockito and AssertJ. The application supports both automatic and manual modes.',
      imgUrl: 'projects_kingdomSimulation.webp',
    ...
    },
    {
      name: 'Raistopy',
      description:
        'Raistopy is an experimental web application developed as part of the "Realizacja Aplikacji Internetowych" laboratory course. The project displays information about public transportation stops using the ZTM Gdańsk API. The entire application is built on a micro-frontends architecture and containerized using Docker.',
      imgUrl: 'projects_raistopy.webp',
      sourceCodeUrl: 'https://github.com/Sladamos/Raistopy',
      teamMembers: 2,
      technologies: [
        this.technologyService.getTechnology('Express.js'),
        this.technologyService.getTechnology('Vue'),
        this.technologyService.getTechnology('CSS'),
        this.technologyService.getTechnology('Mongoose'),
        this.technologyService.getTechnology('Docker'),
        this.technologyService.getTechnology('Cypress'),
      ],
    },
    {
      name: 'SLEMA',
      description:
        'SLEMA is a multi-platform project developed for the Fundacja Toczeń Polska, built using a diverse technology stack that includes Dart and Java. Featuring integrated chat functionality across web and mobile platforms, SLEMA was developed using SCRUM. The project is written in Flutter framework, whereas chat backend is written in Spring framework.',
      imgUrl: 'projects_slema.webp',
      sourceCodeUrl: 'https://github.com/Sladamos/SLEMA',
      teamMembers: 4,
      technologies: [
        this.technologyService.getTechnology('Java'),
        this.technologyService.getTechnology('Spring'),
        this.technologyService.getTechnology('Dart'),
        this.technologyService.getTechnology('Flutter'),
        this.technologyService.getTechnology('Figma'),
      ],
    },
    {
