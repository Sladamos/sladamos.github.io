  ...
  sections = signal([
    {
      ...
      items: [
        ...
        },
        {
          ...
          assetSrc: 'experience_consdata.png',
          description:
            '<ul class="experience__description-list"><li>Resolving backend tasks using Java</li>' +
      ...
      items: [
        {
          ...
          description:
            '<ul class="experience__description-list"><li>Specialization: Geoinformatic and Mobile Technologies</li>' +
        ...
        },
        {
          ...
          assetSrc: 'experience_pg.jpg',
          description:
            '<ul class="experience__description-list"><li>First specialization: Applications</li>' +
        ...
        },
        {
          ...
          description:
            '<ul class="experience__description-list"><li>High exam scores</li>' +
      ...
      items: [
        {
          ...
          description:
            '<ul class="experience__description-list"><li>Contains Capture The Flag section</li>' +
